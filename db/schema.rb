...
ActiveRecord::Schema[7.0].define(version: 2025_05_19_075544) do
  ...
  create_table "conversations", id: :serial, force: :cascade do |t|
    ...
    t.index ["last_handoff_at"], name: "index_conversations_on_last_handoff_at"
