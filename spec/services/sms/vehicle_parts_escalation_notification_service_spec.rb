...
RSpec.describe Sms::VehiclePartsEscalationNotificationService do
  ...
  let!(:user) { create(:user, email: 'parts-lead@example.com', phone_number: '+1234567890') }

  let(:service) { described_class.new(conversation: conversation, emails: ['parts-lead@example.com']) }
