Cruise Control is looking forward to working with security researchers worldwide to keep Cruise Control and our users safe. If you have found an issue in our systems/applications, please reach out to us.
...
> Note: Please do not perform testing against Cruise Control production services. Use a `self-hosted instance` to perform tests.
...
Thank you for keeping Cruise Control and our users safe. 🙇
