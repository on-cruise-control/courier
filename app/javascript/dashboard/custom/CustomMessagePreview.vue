  ...
  <div class="overflow-hidden text-ellipsis whitespace-nowrap">
    <template v-if="showMessageType">
      ...
      <fluent-icon
        ...
        size="18"
        class="-mt-0.5 align-middle text-n-blue-11 inline-block"
        icon="arrow-reply"
      />
      <fluent-icon
        v-else-if="isMessageAnActivity"
        size="18"
        class="-mt-0.5 align-middle text-n-teal-11 inline-block"
        icon="info"
      />
    </template>
    <span v-if="message.content && isMessageSticker">
      <fluent-icon
        size="18"
        class="-mt-0.5 align-middle inline-block text-n-iris-11"
        icon="image"
      />
