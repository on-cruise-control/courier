# This class creates both outgoing messages from Cruise Control and echo outgoing messages based on the flag `outgoing_echo`
# Assumptions
# 1. Incase of an outgoing message which is echo, source_id will NOT be nil,
#    based on this we are showing "not sent from Cruise Control" message in frontend
